...
func (repo *UserRepository) StoreUser(u domain.User) (id int, err error) {
...
func (repo *UserRepository) FindUserById(identifier int) (user domain.User, err error) {
...
func (repo *UserRepository) FindUsers() (users domain.Users, err error) {
